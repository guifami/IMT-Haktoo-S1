 ...
 */
public class PreQuizAdmin extends javax.swing.JFrame {
public String raNumber;
    ...
    public PreQuizAdmin(String raNumber) {
        initComponents();
    }
        ...
        try{
            ...
            while(rrs.next()){
                if(rrs.getInt(1) != 10){
                    ...
                    setVisible(false);
                    new QuizAdmin(raNumber).setVisible(true);
                }
            }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 800, 510, -1));
        ...
        jLabel20.setText("Registro do Aluno");
        ...
        rSButtonHover1.setText("Começar");
        ...
        jPanel1.add(rSButtonHover1, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 680, 310, 100));
        ...
        jLabel21.setFont(new java.awt.Font("Segoe UI", 0, 32)); // NOI18N
        jLabel21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/seta.jpg"))); // NOI18N
        ...
        jPanel1.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(1320, 750, 160, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PreQuizAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PreQuizAdmin().setVisible(true);
            }
        });
    }
