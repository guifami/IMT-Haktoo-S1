...
//            }
        ...
        @Override
            ...
            if(sec==60){
                ...
                if(min==10){
                    ...
                    setEnabled(false);
                    setVisible(false);
                    CustomTimeBox ctb = new CustomTimeBox();
                    ctb.setVisible(true);                    
                    answerCheck();
                    submit();  
                }
    ...
    private void enviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enviarActionPerformed
        ...
        ccb.setVisible(true);
//        int confirmacao = JOptionPane.showConfirmDialog(null, "Você realmente quer Enviar suas respostas?","Select",JOptionPane.YES_NO_OPTION);
//        if(confirmacao == 0){
