 ...
 */
public class ResultadoPage extends javax.swing.JFrame{
    ...
    public ResultadoPage(){
        ...
        try{
            ...
            ResultSet rs = pst.executeQuery("SELECT RA FROM USERS WHERE NAME='"+username+"'");
            while(rs.next()){
                String ra = rs.getString(1);
                ResultSet rsp = st.executeQuery("SELECT * FROM ESTUDANTE WHERE RA='"+ra+"'");
                table.setModel(DbUtils.resultSetToTableModel(rsp));
            }           
        }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResultadoPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ResultadoPage().setVisible(true);
            }
        });
    }
