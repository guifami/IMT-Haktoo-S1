 ...
 * @author guifami
 */
public class CustomTimeBox extends javax.swing.JFrame {
    ...
    public CustomTimeBox(String text) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomTimeBox.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomTimeBox().setVisible(true);
            }
        });
    }
