...
public class HomePageAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        menu_gerenciar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/30 (1).png"))); // NOI18N
        menu_gerenciar.setText("Limpar Resultados");
        ...
        kGradientPanel1.add(menu_gerenciar, new org.netbeans.lib.awtextra.AbsoluteConstraints(-60, 700, 390, 60));
        ...
        menu_gerenciar1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/baixados (1).png"))); // NOI18N
        menu_gerenciar1.setText("Gerenciar");
        ...
        kGradientPanel1.add(menu_gerenciar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-100, 260, 390, 60));
        ...
        jLabel12.setText("Bem vindo(a) Administrador(a)!");
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 280, 540, -1));

        jLabel13.setFont(new java.awt.Font("Segoe UI", 0, 28)); // NOI18N
        jLabel13.setText("Olá administrador(a), você é o(a) responsável por criar, consultar, alterar e excluir");
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 360, 1250, 60));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 0, 28)); // NOI18N
        jLabel6.setText("consultar o resultado de cada aluno após o término da atividade.");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 480, 1090, 60));
        ...
        jLabel7.setText("os exercícios que serão apresentados durante o jogo para os alunos, além de,");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 420, 1090, 60));
    ...
    private void rSButtonHover1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rSButtonHover1MouseClicked
        PreQuizAdmin pq = new PreQuizAdmin();
        pq.setVisible(true);
        this.dispose();
        // TODO add your handling code here:
    ...
    private void rSButtonHover2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rSButtonHover2MouseClicked
        RegrasAdmin rga = new RegrasAdmin();
        rga.setVisible(true);
        this.dispose();
        // TODO add your handling code here:
